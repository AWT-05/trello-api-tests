...
Feature: Test POST, GET, PUT and DELETE without authorization
  ...
  Background: Set initial state
    Given I set authentication using API key and token
    * I have a board created
    * I have a label created
    And I don't set authentication

  Scenario: Try to create a label
  ...
  Scenario: Try to update a label
  ...
  Scenario: Try to delete a label
